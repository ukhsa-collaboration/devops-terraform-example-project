module "state_file" {
  source                  = "git::ssh://git@github.com/ukhsa-collaboration/devops-terraform-modules//terraform-modules/aws/state-file?ref=cebc90e87e2250fcc473e250f7008990fae50737"
